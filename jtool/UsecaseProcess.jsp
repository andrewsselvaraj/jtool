...
<%
		...
		try
			...
			String usecasename = request.getParameter("usecasename");

			String 	sql = "insert into USECASEMASTER  values (USECASE_id_seq.nextval,";
					sql = sql +"'"+usecasename+"',";
					sql = sql +"'"+project_id+"')";					
			...
			if(i>0)
				{
								out.println(usecasename+"Inserted Successfully");
				}
