...
<table width="100%"  border="2" cellpadding="10" cellspacing="10" bordercolor="#000000">
  ...
  <td width=20%>
	...
	<td bgcolor="#FFFFFF">
	 <form action="daogenerate.jsp" method="post" class="style5">
	<table align="center">
	...
	for(int i=0;i<tablename.length;i++)
	{
		...
		if(req_tablename!=null)
		{
			...
			out.println("<input type=Text name=datatype"+j+"  value="+rsm.getColumnTypeName(j)+">");
	...
	%>
		...
		<tr>
	<td colspan=2>
	Enter DAO name : <input type=textfield name=daoname>
	...
	Out put &nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     :
	<select name=output>
	<option>int</option><option>float</option><option>String</option><option>date</option>
	</select>
	...
	<tr>
	<td >
	INPUT : (Please  Enter input values by modifying code)
		...
		<tr>
	<td colspan=2>
	Function Name <input type=textfield name=functionname>
